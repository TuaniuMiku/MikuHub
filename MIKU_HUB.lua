...
-- Phiên bản: v13.0 (Fixed Boss Distance Sliders)
-- =====================================================================
...
-- ==================== TRANG 2: FARM QUÁI & BOSS (FIXED MENU CHỈNH KHOẢNG CÁCH BOSS) ====================
...
-- ⚡ ACCORDION CHIA QUÁI THEO LEVEL
...
-- 💀 MỤC BOSS VÀ THANH CHỈNH KHOẢNG CÁCH TỪNG BOSS (MỚI BỔ SUNG)
...
-- 📐 THANH CHỈNH KHOẢNG CÁCH CHO TỪNG BOSS (TỰ ĐỘNG KHỞI TẠO TỪ _G.BossDistances)
local BossSliderSectionTitle = Instance.new("TextLabel")
BossSliderSectionTitle.Parent = PageMonster
BossSliderSectionTitle.BackgroundTransparency = 1
BossSliderSectionTitle.Size = UDim2.new(1, 0, 0, 18)
BossSliderSectionTitle.Font = Enum.Font.GothamBold
BossSliderSectionTitle.Text = "📏 KHOẢNG CÁCH CHỈNH RIÊNG TỪNG BOSS:"
BossSliderSectionTitle.TextColor3 = MIKU_COLOR
BossSliderSectionTitle.TextSize = 10.5
BossSliderSectionTitle.TextXAlignment = Enum.TextXAlignment.Left

for _, bName in ipairs(bossListOrder) do
    local defaultDist = _G.BossDistances[bName] or 100
    local shortName = string.gsub(bName, "^Lv%d+%s*", "") -- Rút gọn tên hiển thị cho đẹp
    createDistanceSlider(PageMonster, "📏 " .. shortName, defaultDist, 300, function(val)
        _G.BossDistances[bName] = val
    end)
end
